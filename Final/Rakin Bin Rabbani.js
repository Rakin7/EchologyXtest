...
else
{
	...
	for(var check=(Object.keys(b).length)-1;check>=0;check--)
	{
		...
		linkClass.value = "linkC";
		imgDiv2a.setAttributeNode(linkClass);
		*/
		var imgDiv2 = document.createElement("img");
		var imgDivA2 = document.createAttribute("src");
        imgDivA2.value = res1;
        imgDiv2.style.minWidth="137px";
        imgDiv2.style.minHeight="50%";
        imgDiv2.style.maxHeight="100%";
		imgDiv2.setAttributeNode(imgDivA2);

		//style
		
		imgDiv2a.style.border="10px solid white";
	...
	const carouselImages = document.getElementsByClassName("linkC");
